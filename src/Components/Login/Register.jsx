...
import { AiOutlineUser,AiFillPhone ,AiOutlineMail , AiFillLock} from "react-icons/ai";
        ...
        <div className='  rounded-full w-[60%] mx-auto mt-[10vh] flex justify-center text-center items-center '>
          <div className=' py-4 '>
            ...
            <div>
              ...
              <AiOutlineUser className=' text-xl mr-5 text-gray-900 ' />
              ...
              <AiOutlineMail className=' text-xl mr-5 text-gray-900 ' />
                ...
                <div className=' my-5 w-[30vw] sm:w-[70vw] ' >
              <div className=' flex items-center'>
              <AiFillPhone className=' text-xl mr-5 text-gray-900 ' />
                ...
                <div>
                  ...
                  <Link to='/login'><p className=' my-4 text-gray-600 '>Already Have Account</p></Link>
                </div>
              </form>
            </div>
          </div>
